...
The data set consists of 156 variables collected from 3,535 participants. Only a fraction of the columns are of interest for this analysis.^[The [Jan20 Census_methodology.pdf](https://github.com/mpfoley73/pew-2020-census/blob/main/data/Jan20%20Census_methodology.pdf) file located in the project data directory on [GitHub](https://github.com/mpfoley73/pew-2020-census/tree/main/data) includes a codebook of census variables.]
...
<!-- :::: logic below creates style html within document -->
...
```{r}
saveRDS(pew_dat_1, "../data/1_get_data.rds")
```
